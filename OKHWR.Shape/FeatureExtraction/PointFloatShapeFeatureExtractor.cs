...
namespace OKHWR.Shape.FeatureExtraction
{
  public class PointFloatShapeFeatureExtractor
  {
    ...
    public IList<PointFloatShapeFeature> ExtractFeature(TraceGroup inTraceGroup)
    {
      ...
      var feature = new PointFloatShapeFeature { X = xVec[0], Y = yVec[0], SinTheta = sinTheta, CosTheta = cosTheta, IsPenUp = penUpVec[0] };
